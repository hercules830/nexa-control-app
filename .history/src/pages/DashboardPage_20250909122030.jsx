...
function DashboardPage({ user }) {
  ...
  const [editingProduct, setEditingProduct] = useState(null); // Usado para editar Productos e Insumos
  ...
  const [_finishedProducts, _setFinishedProducts] = useState([]); // (Puede unirse con 'products' en el futuro)
  ...
  const handleAddProduct = async (event) => {
    ...
    if (productName.trim() === "" || productPrice.trim() === "" || isNaN(productPrice) || productCost.trim() === "" || isNaN(productCost)) {
