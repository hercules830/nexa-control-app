...
return json({ ok: "bypass-test" }, 200);
  ...
  // ⚠️ Sin verificación de Authorization en local (y en general para simplificar las pruebas)
  // Si luego quieres exigir JWT en producción, agrega aquí la lógica y un flag ENV=production.
