                  ...
                  <ul className={styles.insumoList}>
                    {filteredInsumos.length === 0 ? (<p>No se encontraron insumos.</p>) : (filteredInsumos.map((insumo) => (
                      ...
                      className={`${styles.insumoItem} ${
                        (insumo.alertThreshold != null && insumo.stockInUsageUnit <= insumo.alertThreshold)
                          ? styles.lowStock
                          : ""
                      }`}
                    >
                      <div className={styles.insumoInfo}>
                        ...
                        <span className={styles.insumoCost}>
                          Costo: ${(insumo.costPerUsageUnit || 0).toFixed(2)} / {insumo.usageUnit}
                        </span>
                      </div>
                      <div className={styles.insumoDetails}>
                        <div className={styles.actionButtons}>
                          ...
                          <span className={styles.quantityText}>
                            {insumo.stockInUsageUnit} <span className={styles.unitText}>{insumo.usageUnit}</span>
                          </span>
            ...
            <motion.div className={styles.modalContent} initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -50, opacity: 0 }}>
              ...
              {editingItem.itemType === 'product' && (
                <form onSubmit={handleUpdateProduct}>
                   ...
                   <p>La edición de productos con recetas se implementará pronto.</p>
                   <div className={styles.modalActions}>
