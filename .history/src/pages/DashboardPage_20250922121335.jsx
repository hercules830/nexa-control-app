...
const handleCancelSubscription = async () => {
  ...
  try {
    ...
    toast.success("Tu suscripción ha sido programada para cancelación. Tu acceso permanecerá activo hasta el final del período.");
    
    // Forzamos una actualización del estado local para que la UI cambie inmediatamente
    // Asumiendo que tienes una función para refrescar el perfil desde App.jsx
    // Si no, puedes simplemente recargar la página o actualizar el estado localmente.
    // Por ahora, recargaremos los datos del dashboard.
    fetchProducts();
    fetchInsumos();
    fetchSales();
  ...
  <div className={styles.subscriptionSection}>
    ...
    {/* Necesitarás pasar el 'subscriptionStatus' como prop desde App.jsx */}
    {subscriptionStatus === 'active' || subscriptionStatus === 'trialing' ? (
      <>
        <p>Tu plan está actualmente activo.</p>
        <button 
          onClick={handleCancelSubscription} 
          className={styles.cancelButton} // Asegúrate de crear este estilo
