...
function App() {
 ...
 // 2. Renombra esta función para que sea más clara
 const handleNavigateToPricing = () => {
  setCurrentView('pricing'); // Ahora navega a la página de planes
};
  ...
  const renderContent = () => {
    ...
    switch (currentView) {
      ...
      // 3. Añade el nuevo caso para la página de planes
      case 'pricing':
        return <PricingPage key="pricingPage" onNavigateToLogin={handleNavigateToLogin} />;

      case 'welcome':
      default:
        // 4. Asegúrate de que WelcomePage ahora llame a la función correcta
