...
function LoginPage({ onNavigateToWelcome }) {
  ...
  const handleRegister = async () => {
    ...
    // Llamar Edge Function para crear cliente en Stripe
    const resp = await fetch(
      "https://<TU-PROJECT-REF>.functions.supabase.co/create-stripe-customer",
      {
        method: "POST",
    ...
    console.log("Cliente creado en Stripe:", stripeCustomer);
  };
