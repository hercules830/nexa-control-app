...
// Esta función nos permite "dormir" o esperar por un tiempo determinado.
...
serve(async (req) => {
  ...
  try {
    if (event.type === 'checkout.session.completed') {
      ...
      // --- ¡AQUÍ ESTÁ LA MAGIA! BUCLE DE REINTENTO ---
      while (!profile && attempts < maxAttempts) {
        attempts++;
        console.log(`Intento #${attempts}: Buscando perfil para customer_id: ${customerId}`);
