...
function PricingPage() {
  ...
  const handleCheckout = async (priceId) => {
    try {
      ...
      // En la respuesta de la función, ahora espero una URL completa
      if (data?.checkoutUrl) {
    ...
    >
      ...
      <div className={styles.cardsGrid}>
        ...
        <div className={styles.pricingCard}>
          ...
          <button
            onClick={() => handleCheckout("price_1P8LhDAb2sO5y1EaX9b4c3Z2")} // ID de precio real de Stripe para el plan Básico
        ...
        {/* --- Plan Pro (Comentado hasta que tengas el ID de precio real de Stripe) --- */}
        {/*
        <div className={`${styles.pricingCard} ${styles.featuredCard}`}>
          ...
          <button
            onClick={() => handleCheckout("AQUI_VA_EL_ID_DE_PRECIO_PRO")}
            className={styles.ctaButton}
            disabled={loading}
          >
            {loading ? "Procesando..." : "Comenzar Prueba"}
