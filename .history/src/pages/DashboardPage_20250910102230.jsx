            ...
            <section className={styles.card}>
              ...
              <div className={styles.filtersContainer}>
                ...
                >
                  ...
                  {/* Filtramos la lista de productos para mostrar solo los que tienen receta */}
              ...
              {(() => {
                // Inicia con todos los insumos
                let filteredInsumos = [...insumos];

                // 1. Primero, filtra por la receta del producto seleccionado (si hay uno)
                ...
                // 2. Luego, filtra por el término de búsqueda de texto (sobre el resultado anterior)
                if (searchTerm) {
