...
function LoginPage({ onNavigateToWelcome }) {
  ...
  const handleRegister = async () => {
    ...
    // Llamar a la función Edge para crear el cliente en Stripe
    ...
    if (!resp.ok) {
      console.error("Error creando cliente en Stripe:", await resp.text())
      return
    }
  
    const { customerId } = await resp.json()
    console.log("Cliente creado en Stripe con ID:", customerId)
  }
