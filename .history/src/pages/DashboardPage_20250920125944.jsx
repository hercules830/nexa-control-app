...
function DashboardPage({ user }) {
  ...
  const handleFinalizeSale = async () => {
    ...
    try {
      const salesInsertData = currentTicket.map((ticketItem) => ({ ticket_id: Date.now(), product_id: ticketItem.productId, product_name: ticketItem.name, quantity: ticketItem.quantity, price: ticketItem.price, cost: ticketItem.cost, profit: (ticketItem.price - ticketItem.cost) * ticketItem.quantity, payment_method: paymentMethod, date: new Date().toISOString(), user_id: user.id }));
