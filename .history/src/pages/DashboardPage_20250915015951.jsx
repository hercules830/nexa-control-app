...
function DashboardPage({ user }) {
  ...
  useEffect(() => {
    ...
    const insumosChannel = supabase.channel('public:insumos')
      .on('postgres_changes', { event: '*', schema: 'public', table: 'insumos' }, fetchAllData)
      .subscribe();

    const salesChannel = supabase.channel('public:sales')
